var config = {
  ...
  localServerUrlMap: {
    index: 'http://epc.baic.dev.servision.com.cn/epc/catalog'
  },
  partnerApp: {
    epcmServer: {
      host: 'epcm.baic.dev.servision.com.cn',
      port: 80,
      requestPrefix: ''
    },
    fileServer: {
  ...
  path: 'http://epc.baic.dev.servision.com.cn',
  toEpcmUrl: 'http://epcm.baic.dev.servision.com.cn',
